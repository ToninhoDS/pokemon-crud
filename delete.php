...
if($cd_pokemon == ""){
  echo '<div class="alert alert-danger" style="text-align: center;font-size:40px;font-family: Archivo Narrow, sans-serif;" role="alert">
  Precisa digitar o codigo ou não esta correto!!!
 </div>';
...
if ($conn->connect_error) {
  ...
  $sql = "DELETE FROM tb_pokemon WHERE cd_pokemon = $cd_pokemon";
